...
(function() {
  ...
  var t = {
    da: {
      ...
      footer: { privacy: 'Privatlivspolitik', terms: 'Vilkår og betingelser', collab: 'Samarbejde', support: 'Support', deleteAccount: 'Slet konto', moreLangs: 'Flere sprog...' },
      ...
      deleteAccount: {
        title: 'Slet din Gymly-konto',
        intro: 'Du kan anmode om permanent sletning af din Gymly-konto og de data, der er knyttet til kontoen.',
        inAppBefore: 'Hvis du stadig har adgang til Gymly-appen, kan du slette din konto direkte under:',
        inAppPath: 'Profil → Indstillinger → Slet konto',
        formIntro: 'Hvis du ikke længere har adgang til appen, kan du sende en anmodning herunder.',
        verifyNote: 'Når vi modtager din anmodning, sender vi en bekræftelsesmail til den angivne e-mailadresse for at kontrollere, at du ejer kontoen.',
        deletedTitle: 'Efter bekræftelse slettes:',
        deleted1: 'Brugerprofil',
        deleted2: 'Træningshistorik og check-ins',
        deleted3: 'Opslag, billeder og kommentarer',
        deleted4: 'Beskeder og sociale forbindelser',
        deleted5: 'Streaks, badges og øvrige kontodata',
        emailLabel: 'E-mailadresse tilknyttet Gymly-kontoen',
        emailPlaceholder: 'din@email.dk',
        messageLabel: 'Valgfri besked',
        optional: '(valgfrit)',
        messagePlaceholder: 'Tilføj evt. en kort besked',
        checkbox: 'Jeg forstår, at min konto og tilknyttede data slettes permanent.',
        submit: 'Anmod om sletning',
        success: 'Hvis der findes en Gymly-konto med denne e-mailadresse, modtager du en bekræftelsesmail.',
        invalidEmail: 'Angiv en gyldig e-mailadresse.',
        mustConfirm: 'Du skal bekræfte, at du forstår sletningen.',
        retention: 'Visse oplysninger kan opbevares i en begrænset periode, hvis det er nødvendigt af hensyn til sikkerhed, forebyggelse af misbrug eller juridiske krav.',
        backHome: 'Tilbage til forsiden',
        confirmLoading: 'Bekræfter anmodning…',
        confirmWait: 'Vent et øjeblik, mens vi behandler dit link.',
        confirmSuccessTitle: 'Anmodning bekræftet',
        confirmSuccessBody: 'Din anmodning om kontosletning er modtaget. Vi behandler sletningen inden for kort tid.',
        confirmErrorTitle: 'Linket virker ikke',
        confirmErrorBody: 'Linket er ugyldigt eller udløbet. Anmod om sletning igen fra sletningssiden.',
        confirmRetry: 'Gå til sletningssiden'
      },
      samarbejde: { title: 'Samarbejde', intro: 'Vil du samarbejde med Gymly? Udfyld formularen herunder, så vender vi tilbage til dig.' },
      checkin: { title: 'Tjek ind', yourCenter: 'Dit center', planTraining: 'Planlagte sessions', swipeToCheckin: 'Swipe for at tjekke ind', soloTraining: 'Solo træning', soloDesc: 'Skjul denne træning for venner' },
    ...
    en: {
      ...
      footer: { privacy: 'Privacy Policy', terms: 'Terms and Conditions', collab: 'Collaboration', support: 'Support', deleteAccount: 'Delete account', moreLangs: 'More languages...' },
      ...
      deleteAccount: {
        title: 'Delete your Gymly account',
        intro: 'You can request permanent deletion of your Gymly account and the data associated with it.',
        inAppBefore: 'If you still have access to the Gymly app, you can delete your account directly under:',
        inAppPath: 'Profile → Settings → Delete account',
        formIntro: 'If you no longer have access to the app, you can submit a request below.',
        verifyNote: 'When we receive your request, we will send a confirmation email to the address provided to verify that you own the account.',
        deletedTitle: 'After confirmation, the following will be deleted:',
        deleted1: 'User profile',
        deleted2: 'Workout history and check-ins',
        deleted3: 'Posts, photos and comments',
        deleted4: 'Messages and social connections',
        deleted5: 'Streaks, badges and other account data',
        emailLabel: 'Email address linked to your Gymly account',
        emailPlaceholder: 'you@email.com',
        messageLabel: 'Optional message',
        optional: '(optional)',
        messagePlaceholder: 'Add a short message if you wish',
        checkbox: 'I understand that my account and associated data will be permanently deleted.',
        submit: 'Request deletion',
        success: 'If a Gymly account exists with this email address, you will receive a confirmation email.',
        invalidEmail: 'Please enter a valid email address.',
        mustConfirm: 'You must confirm that you understand the deletion.',
        retention: 'Certain information may be retained for a limited period where necessary for security, abuse prevention or legal requirements.',
        backHome: 'Back to homepage',
        confirmLoading: 'Confirming request…',
        confirmWait: 'Please wait while we process your link.',
        confirmSuccessTitle: 'Request confirmed',
        confirmSuccessBody: 'Your account deletion request has been received. We will process the deletion shortly.',
        confirmErrorTitle: 'This link does not work',
        confirmErrorBody: 'The link is invalid or has expired. Please request deletion again from the deletion page.',
        confirmRetry: 'Go to deletion page'
      },
      samarbejde: { title: 'Collaboration', intro: 'Want to collaborate with Gymly? Fill out the form below and we will get back to you.' },
      checkin: { title: 'Check in', yourCenter: 'Your center', planTraining: 'Planned sessions', swipeToCheckin: 'Swipe to check in', soloTraining: 'Solo training', soloDesc: 'Hide this workout from friends' },
    ...
    pl: {
      ...
      footer: { privacy: 'Polityka prywatności', terms: 'Regulamin', collab: 'Współpraca', support: 'Wsparcie', deleteAccount: 'Usuń konto', moreLangs: 'Więcej języków...' },
    ...
    de: {
      ...
      footer: { privacy: 'Datenschutz', terms: 'AGB', collab: 'Zusammenarbeit', support: 'Support', deleteAccount: 'Konto löschen', moreLangs: 'Weitere Sprachen...' },
